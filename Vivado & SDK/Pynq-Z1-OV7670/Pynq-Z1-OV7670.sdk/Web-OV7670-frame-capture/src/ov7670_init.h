...
//ovo možda treba promijeniti kad se stavi kamera

#define OV7670ADDR_READ	0x21
#define OV7670ADDR_WRITE	0x21
...
struct regval_list {
	u8 reg_num; //unsigned char reg_num;
	u8 reg_val; //unsigned char value;
};
...
static struct regval_list ov7670_image[] = {
	{ 0x70, 0x4A },	
	{ 0x71, 0x35 },	
	//{ REG_TSLB,  0x14 },	/* OV */ // ------------------ PRIJE BILO 0x04!!!
	//{ REG_MANU, 0x22},
	//{ REG_MANV, 0x11},
	{ 0xff, 0xff }
};
...
int  InitCamera(void);
void InitRegs(struct regval_list *ov7670_reg_list);
void InitDefaultReg(struct regval_list *ov7670_reg_list);
...
//void InitVGA(struct regval_list *ov7670_reg_list);
//void InitQVGA(regval_list *ov7670_reg_list);
