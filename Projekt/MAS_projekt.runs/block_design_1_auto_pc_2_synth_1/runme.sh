...
HD_PWD='C:/Vivado_Projects/MAS/Projekt/MAS_projekt.runs/block_design_1_auto_pc_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block_design_1_auto_pc_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source block_design_1_auto_pc_2.tcl
